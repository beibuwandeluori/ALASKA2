...
from network.model import get_efficientnet, RGB_N_EfficientNet
...
if __name__ == '__main__':
    ...
    writeFile = 'output/logs/rgb_n_efficientnet/' + model_name + '_4c.out'  # DCT_YCrCb
    store_name = 'output/weights/rgb_n_efficientnet/' + model_name + '_4c.pth'
    model_path = None
    base_model_path = 'output/weights/efficientnet/efficientnet-b2_4c.pth49'

    # Load model
    model = RGB_N_EfficientNet(model_name=model_name, num_classes=4, model_path=base_model_path)
    # print(model)
