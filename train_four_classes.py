...
if __name__ == '__main__':
    ...
    # writeFile = 'output/logs/DCT_efficientnet_YCrCb/' + model_name + '_YCrCb_DCT_4c.out'  # DCT_YCrCb
    # store_name = 'output/weights/DCT_efficientnet_YCrCb/' + model_name + '_YCrCb_DCT_4c.pth'
    model_name = 'efficientnet-b4'
    writeFile = 'output/logs/efficientnet_YCrCb/' + model_name + '_YCrCb_4c.out'  # DCT_YCrCb
    store_name = 'output/weights/efficientnet_YCrCb/' + model_name + '_YCrCb_4c.pth'
    # model_path = None
    model_path = 'output/weights/efficientnet/efficientnet-b4_4c.pth73'

    # Load model
    # model, *_ = model_selection(modelname=model_name, num_out_classes=2, dropout=0.5)
    # model, *_ = model_selection(modelname=model_name, num_out_classes=4, is_DCT_new=True, is_SRM=False)
    model = get_efficientnet(model_name=model_name)
    # model = DCT_EfficientNet(model_name=model_name,
    #                          model_path='/data1/cby/py_project/ALASKA2/output/weights/efficientnet_YCrCb/efficientnet-b2_YCrCb_4c.pth51')
    # print(model)
