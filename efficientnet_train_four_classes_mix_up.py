...
if __name__ == '__main__':
    ...
    writeFile = 'output/logs/efficientnet/' + model_name + '_mixup_4c.out'  # DCT_YCrCb
    store_name = 'output/weights/efficientnet/' + model_name + '_mixup_4c.pth'
    # model_path = None
    ...
    if is_train:
        ...
        best_weight_auc = 0.9214  # if epoch_start == 0 else eval_model(model, epoch_start, eval_loader)
