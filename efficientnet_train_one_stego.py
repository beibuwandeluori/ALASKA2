...
if __name__ == '__main__':
    ...
    device_id = 0
    lr = 0.00002
    use_one_cover_type = 2  # [0:JMiPOD_images, 1:JUNIWARD_images, 2:UERD_images, 3:All]
    # model_name = 'resnet18'
    model_name = 'efficientnet-b0'
    writeFile = 'output/logs/efficientnet_stego/' + model_name + '_UERD_2c.out'  # DCT_YCrCb
    store_name = 'output/weights/efficientnet_stego/' + model_name + '_UERD_2c.pth'
    # model_path = None
    model_path = 'output/weights/efficientnet_stego/' + model_name + '_UERD_2c.pth5'
    # model_path = 'output/weights/efficientnet/efficientnet-b0_4c.pth34'

    # Load model
    model = get_efficientnet(model_name=model_name, num_classes=2)
    ...
    # model._fc = nn.Linear(in_features=in_features, out_features=2, bias=True)
    # print(model)
    ...
    if is_train:
        ...
        xdl = DatasetRetriever(is_one_hot=True, data_type='train', transforms=get_train_transforms(),
                               classes_num=2, use_one_cover_type=use_one_cover_type)
