...
if __name__ == '__main__':
    ...
    writeFile = 'output/logs/efficientnet_YCrCb_QF/' + model_name + '_YCrCb_QF' + str(QF) + '_4c.out'  # DCT_YCrCb
    store_name = 'output/weights/efficientnet_YCrCb_QF/' + model_name + '_YCrCb_QF' + str(QF) + '_4c.pth'
    # model_path = None
    ...
    if is_train:
        ...
        xdl = AlaskaDataset(data_type='train', classes_num=4, is_YCrCb=is_YCrCb, QF=QF,
        ...
        xdl_eval = AlaskaDataset(data_type='val', classes_num=4, is_YCrCb=is_YCrCb, QF=QF,
        ...
        epoch_start = 1
        num_epochs = 1
        xdl_test = AlaskaDataset(data_type='val', classes_num=4, is_YCrCb=is_YCrCb, QF=QF,
                                 is_albumentations=is_albumentations, is_one_hot=False)
