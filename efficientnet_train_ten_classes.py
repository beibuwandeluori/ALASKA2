...
if __name__ == '__main__':
    ...
    writeFile = 'output/logs/efficientnet/' + model_name + '_10c.out'  # DCT_YCrCb
    store_name = 'output/weights/efficientnet/' + model_name + '_10c.pth'
    model_path = None
    # model_path = '/data1/cby/py_project/ALASKA2/output/weights/efficientnet/efficientnet-b2_4c.pth28'

    # Load model
    model = get_efficientnet(model_name=model_name, num_classes=10)
    print(model)
